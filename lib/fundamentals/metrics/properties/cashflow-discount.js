...
const getTrailingTwelveMonthsDiscountCashflowBy = (summary, date, maxGrowthRate) => {
  ...
  // console.log(earningsPerShareDiluted, date);
  ...
  // console.log(currentEarnings, date);
...
module.exports = {
  ...
  getTrailingTwelveMonthsDiscountCashflowBy,
};
