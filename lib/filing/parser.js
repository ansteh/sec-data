...
const prepareContext = (entry, filing, defaultMember) => {
  ...
  return Object.assign({ property: defaultMember, member, value }, getPeriod(ref));
};
...
const Mapping = {
  ...
  CommonStockDividendsPerShareCashPaid: {
    key: 'us-gaap:CommonStockDividendsPerShareCashPaid',
    prepare: defaultPrepare('us-gaap:CommonStockDividendsPerShareCashPaid')
  },
  ...
  SharesOutstanding: {
    key: 'us-gaap:SharesOutstanding',
    prepare: defaultPrepare('us-gaap:SharesOutstanding')
  },
