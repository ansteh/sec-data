...
const filingFile = `${__dirname}/../../../resources/stocks/GME/files/10-K_2012-03-27.xml`;
// const filingFile = `${__dirname}/../../../resources/stocks/GME/files/10-K_2017-03-27.xml`;
...
const testParseFiling = () => {
  return Filing.Parser.parseFile(filingFile)
    .then((content) => {
      ...
      console.log('EarningsPerShareDiluted', content['us-gaap:EarningsPerShareDiluted']);
