...
const testParseFiling = () => {
  ...
  return Filing.Parser.parseFile(filingFile)
    .then((content) => {
      ...
      console.log('CommonStockDividendsPerShareDeclared', content['us-gaap:CommonStockDividendsPerShareDeclared']);
      console.log('CommonStockDividendsPerShareCashPaid', content['us-gaap:CommonStockDividendsPerShareCashPaid']);
