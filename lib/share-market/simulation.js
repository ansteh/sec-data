...
const create = ({
  ...
  const buyShares = (states) => {
    let candidates = {};
    candidates = {};
    _.forOwn(states, (candidate, ticker) => {
      if(candidate.margin && candidate.margin > buyMargin) {
