...
// const INTRINSIC_VALUE_PATH = 'annual.FreeCashFlow_IntrinsicValue';
...
ShareMarket.getMarket()
  ...
  .then((marketTimeline) => {
    ...
    do {
      marketTimeline.simulate(INTRINSIC_VALUE_PATH);
      marketTimeline.clear();
      console.log(new Date());
    } while(true);

    // console.log(marketTimeline.market.getShareMarketSpreads());
    // console.log(marketTimeline.market.getSpreadGrowthRateByTicker('GM'));
    // console.log(JSON.stringify(marketTimeline.market.getShareMarketSpreadsOfStocksAnnualGrowthRateGreaterThan(10), null, 2));
