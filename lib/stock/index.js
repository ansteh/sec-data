...
//     .then(getFormTypes)
//     .then((formTypes) => {
//       const batchedFormEntries = formTypes.map((formType) => {
//         return find(ticker, entry, formType).then(filter);
//       });
//
//       return Promise.all(batchedFormEntries)
//         .then((batches) => {
//           const candidates = _
//             .chain(batches)
//             .flatten()
//             .value();
//
//           return PeriodReducer.toTimeseries(candidates);
//         });
//     });
// }
