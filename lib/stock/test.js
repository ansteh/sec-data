...
// Stock.updateMissingStockFilings(['OSN']);
// Stock.getTickersFromResourcesFrom('OSN')
//   .then(Stock.updateMissingStockFilings);
// Stock.downloadMissingFilingFilesBy();

// Stock.unlinkAllBrokenFiles()
//   .then(console.log)
//   .catch(console.log);

// Stock.findBrokenFiles('DAL')
//   .then(console.log)
//   .catch(console.log);

// Stock.unlinkBrokenFiles('DAL')
//   .then(console.log)
//   .catch(console.log);

Stock.parseUnparsedFilings();

// Stock.getTickersFromResourcesFrom('GEO')
//   .then(Stock.updateMissingStockFilings);

// Stock.getTickersFromResourcesFrom('PG')
//   .then(Stock.downloadMissingFilingFilesBy);
