...
// getMetrics('GM', 'WeightedAverageNumberOfDilutedSharesOutstanding')
...
Service.getSummary('AAOI')
  .then((stock) => {
    return _.get(stock, 'AAOI.annual');
  })
  .then((filings) => {
    return fundamentals.getTotalAssets(filings);
  })
  .then(console.log)
  .catch(console.log);
